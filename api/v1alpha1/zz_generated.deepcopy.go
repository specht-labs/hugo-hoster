...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HugoSitePreviewSpec) DeepCopyInto(out *HugoSitePreviewSpec) {
	*out = *in
	if in.Branch != nil {
	...
	if in.ExcludeBranch != nil {
		in, out := &in.ExcludeBranch, &out.ExcludeBranch
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HugoSitePreviewSpec.
func (in *HugoSitePreviewSpec) DeepCopy() *HugoSitePreviewSpec {
	if in == nil {
		return nil
	}
	out := new(HugoSitePreviewSpec)
	in.DeepCopyInto(out)
	return out
}
